...
layout: "page"
summary: "Detailed professional history of Asif Iqbal"
---
...
* **Performance:** Improved deployment times by **50%** by implementing robust CI/CD pipelines.
...
* **Infrastructure Automation:** Designed automated infrastructure pipelines using Ansible, AWS, Docker, and Kubernetes.
* **Monitoring:** Managed Prometheus and Grafana for multiple applications, resulting in faster issue resolution.
...
* **Cloud Management:** Managed AWS resources using Terraform and CloudFormation.
* **Containerization:** Deployed Docker containers on AWS and managed orchestration with Kubernetes.
* **Database:** Administered MySQL/PostgreSQL databases, including automated backups and disaster recovery strategies.
* **Load Balancing:** Configured Nginx for load balancing and SSL termination.
...
* **Star of the Learners Group** - TCS ILP (2017)
